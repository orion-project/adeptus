...
#include "../utils/bugitemdelegate.h"
#include "../widgets/markdowneditor.h"
...
static QMap<int, BugSolver*> __BugSolver_openedWindows;
static QByteArray __BugSolver_storedGeometry;
